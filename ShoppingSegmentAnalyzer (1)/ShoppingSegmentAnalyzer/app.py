...
def main():
    ...
    if data_source == "Use Sample Data":
        ...
        if uploaded_file is not None:
            df = pd.read_csv(uploaded_file, sep=';')  # Added separator for semicolon-separated files
    ...
    if df is not None:
        try:
            ...
            st.info("Please ensure your CSV file is properly formatted with semicolon (;) separators")
